...
public class CommandTP implements ICommand {
    ...
    public String reactBadArgsSize(String usedCmd) {
        return "§4" + DigitalClock.getMessagePrefix() + "§c Correct usage: '/" + usedCmd + " tp <name>'";
    }
    ...
    public void process(DigitalClock main, Player player, String[] args) {
        ...
        player.sendMessage("§2" + DigitalClock.getMessagePrefix() + "§a You have been successfully teleported to your clock '" + args[1] + "'.");
    }
}
