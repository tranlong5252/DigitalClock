...
public class Commands implements CommandExecutor {
    ...
    static {
        ...
        commandList.put("seconds", CommandToggleseconds.class);
        commandList.put("hours", CommandTogglehours.class);
        commandList.put("ingametime", CommandToggleingametime.class);
        commandList.put("ampm", CommandToggleampm.class);
